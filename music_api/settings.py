...
SECRET_KEY = 'django-insecure-2lo(#htki1^x6_u-od1le@fw9u@o203=tn##&k^)u*x8c9lx&z'
...
# Libera todos os domínios (ideal para desenvolvimento)
CORS_ALLOW_ALL_ORIGINS = True

# Configuração do DRF para evitar problemas de autenticação
REST_FRAMEWORK = {
